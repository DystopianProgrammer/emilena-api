...
public class CustomCredentialAuthFilter<P extends Principal> extends AuthFilter<BasicCredentials, P> {

    private CustomCredentialAuthFilter() {
    }
    ...
    public static class Builder<P extends Principal> extends
            AuthFilterBuilder<BasicCredentials, P, CustomCredentialAuthFilter<P>> {

        @Override
        protected CustomCredentialAuthFilter<P> newInstance() {
            return new CustomCredentialAuthFilter<>();
        }
    }
}
